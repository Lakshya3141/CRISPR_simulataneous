...
def ter_onsite_eqns(i_arr, j_arr, sys_arr, p, dt):
    ...
    sys_arr[0] = brentq(f=free_d, a=0, b=p["d_t"], args=(sys_arr[1], p["no_mcp_on_k_i"], 
                                    p["no_mcp_on_q_i"], g_i, p["Di_t"], 
                                    p["no_mcp_on_k_j"], p["no_mcp_on_q_j"], 
                                    g_j, p["Dj_t"], p["d_t"]))                                
    sys_arr[1] = brentq(f=free_m, a=0, b=p["m_t"], args=(sys_arr[0], p["no_mcp_on_k_i"], 
                                    p["no_mcp_on_q_i"], g_i, p["Di_t"], 
                                    p["no_mcp_on_k_j"], p["no_mcp_on_q_j"], 
                                    g_j, p["Dj_t"], p["m_t"]))                                                            
    ...
    i_arr[2] = p["no_mcp_on_k_i"]*g_i*d*m
    j_arr[2] = p["no_mcp_on_k_j"]*g_j*d
    i_arr[3] = p["no_mcp_on_q_i"]*p["no_mcp_on_k_i"]*g_i*d*m*D_i
    j_arr[3] = p["no_mcp_on_q_j"]*p["no_mcp_on_k_j"]*g_j*d*D_j 
